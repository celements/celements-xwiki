...
import com.celements.model.classes.fields.UserField;
...
public class XWikiGroupsClass extends AbstractClassDefinition implements IOldCoreClassDef {
  ...
  public static final ClassField<XWikiUser> FIELD_MEMBER = new UserField.Builder(CLASS_FN,
      "member").prettyName("Member").size(30).build();
