...
public interface ComponentManager {
   ...
   *          the descriptor of the component to register.
   * @throws ComponentRepositoryException
   *           error when registering component descriptor.
   * @since 1.7M1
   */
   ...
   *          the initial component instance
   * @throws ComponentRepositoryException
   *           error when registering component descriptor.
   * @since 2.0M2
   */
   ...
   * @param roleHint
   *          the hint identifying the component
   * @since 2.0M2
   */
   ...
   * @param roleHint
   *          the hint identifying the component
   * @return the descriptor for the component matching the passed parameter or null if this
  ...
  /**
   * @param <T>
   *          the role class for which to return all component implementations
   * @param role
   *          the role class for which to return all component implementations
